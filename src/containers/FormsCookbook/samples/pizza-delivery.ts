...
export const pizzaDeliveryMenu: FormCookbookSample = {
  ...
  values: {
    ...
    categories: [
      { key: "traditional", title: "Traditional", pizzas: [{ name: "Cheese", description: "Cheese description." }] },
      {
        key: "premium",
        title: "Premium",
        pizzas: [{ name: "Double Cheese Pizza", description: "Double Cheese description." }]
      }
    ]
  }
};
