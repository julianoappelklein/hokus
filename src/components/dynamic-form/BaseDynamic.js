...
export class BaseDynamic<Field: IField,State> extends React.Component<ComponentProps<Field>, State> {

    // override this to set defaults in the field configuration.
    extendField(field : Field): void{
    ...
    buildPathFragment(node: DynamicFormNode<Field>, nodeLevel: number, nodes: Array<DynamicFormNode<IField>>): ?string {
    ...
    buildBreadcumbFragment(currentNode: DynamicFormNode<Field>, buttons: Array<{label: string, node: DynamicFormNode<IField>}>): void{
