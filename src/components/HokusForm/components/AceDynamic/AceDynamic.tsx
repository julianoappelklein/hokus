      ...
      <DefaultWrapper style={{ display: "flex", justifyContent: "space-between" }}>
        <div style={{ flex: 1, marginRight: "7px", position: "relative" }}>
          <div
            style={{
              height: height,
              background: lightTheme ? "#eeeeee" : "#15101d",
              position: "relative",
              padding: "20px 0",
              paddingRight: lightTheme ? "1px" : undefined,
              borderRadius: "10px"
            }}
          >
            <AceEditor
        ...
        {centerColItems.length ? <div style={{ flex: "0 0 20px" }}>{centerColItems}</div> : undefined}
        <div style={{ height: height, flex: 1, marginLeft: "7px", position: "relative" }}>
          <Paper zDepth={1} rounded={false} style={{ height: "100%", overflow: "auto" }}>
            <div
              className="markdown"
              style={{ padding: 20, paddingBottom: height, boxSizing: "content-box", position: "relative" }}
