  ...
  fields: [
    {
      ...
      title: "Base URL",
      type: "readonly",
      tip: "Yeah, this is a readonly field. Just in case you don't want an editor messing up with your website."
    },
      ...
      fields: [
        {
          ...
          title: "Author",
          type: "string",
          tip: 'This property is inside "params", but we\'ll gone abstract this in the UI.'
        },
        {
          key: "description",
          title: "Description",
