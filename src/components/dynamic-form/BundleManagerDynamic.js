...
class BundleManagerDynamic extends BaseDynamic<BundleManagerDynamicField,void> {
    ...
    buildPathFragment(node: DynamicFormNode<BundleManagerDynamicField>, nodeLevel: number, nodes: Array<DynamicFormNode<IField>>): ?string {
        return undefined;
    }
   ...
   normalizeState({state, field, stateBuilder} : {state:any, field:BundleManagerDynamicField, stateBuilder: any}){
    ...
    shouldComponentUpdate(nextProps: ComponentProps<BundleManagerDynamicField>, nextState: void): bool{
        return true;
    }
