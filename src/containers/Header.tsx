...
const Header = ({minimizeHandler, toggleMaximizeHandler, closeHandler, isMaximized}: any)=>{
    return <header style={{ ["WebkitAppRegion" as any]: 'drag'}} className='App-header'>
        <Route render={({history})=>
            <img
                style={{ ["WebkitAppRegion" as any]: 'no-drag', cursor:'pointer'}}
                src={logo}
        ...
        <div style={{position:'absolute', right:'10px', top:'-3px', ["WebkitAppRegion" as any]: 'no-drag'}}>
